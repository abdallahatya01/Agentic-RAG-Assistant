...
from config import OPEN_ROUTER_API_KEY, GROQ_API_KEY
...
#llm = LLM(model="openrouter/meta-llama/llama-3.3-70b-instruct:free",temperature=0,api_key=OPEN_ROUTER_API_KEY)
